        ...
        <div className="space-y-6">
          <div className="bg-slate-700/50 rounded-2xl p-6">
            ...
            <input
              ...
              className="w-full bg-slate-800 text-white text-3xl font-mono rounded-xl px-4 py-3 border border-slate-600 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
            />
          </div>
